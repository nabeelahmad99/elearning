    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <div class="card-tools">
                <a class="primary-link new_faculty" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New</a>
            </div>
        </div>
        <div class="card-body">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item action_class" href="javascript:void(0)"
                                        data-id="<?php echo $row['faculty_id'] ?>">Load Class</a>
...
$(document).ready(function() {
    ...
    $('.action_class').click(function() {
        uni_modal("Load Class", "./faculty/manage_class.php?faculty_id=" + $(this).attr('data-id'),
            'mid-large')
    })
