    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="faculty_id" id="faculty_id"
                    value="<?php echo isset($faculty_id) ? $faculty_id : '' ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="middlename" id="middlename"
                    value="<?php echo isset($middlename) ? $middlename : '' ?>" placeholder="(optional)">
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control form-control-sm" name="address" id="address"
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp == 1) {
                    ...
                    var _msg =
                        "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Faculty ID already exists.</div>"
                    _frm.prepend(_msg)
