    ...
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <form action="" id="system-frm">
                ...
                <div class="form-group">
                    ...
                    <textarea name="welcome_message" id="" cols="30" rows="10"
                        class="form-control summernote"><?php echo  is_file(base_app . "welcome.html") ? file_get_contents(base_app . "welcome.html") : '' ?></textarea>
                </div>
                <div class="form-group">
        ...
        <div class="card-footer">
            <div class="col-md-12 text-right">
                <button class="primary-button w-80" form="system-frm">Update</button>
            </div>
        </div>
