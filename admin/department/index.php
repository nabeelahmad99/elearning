...
<div class="card card-outline cardprimary w-fluid">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a class="primary-link new_department" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New</a>
        </div>
    </div>
    <div class="card-body">
...
$(document).ready(function() {
    ...
    $('.action_edit').click(function() {
        uni_modal("Edit department", "./department/manage_department.php?id=" + $(this).attr(
            'data-id'));
    })
