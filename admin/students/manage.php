    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" name="student_id" id="student_id"
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp == 1) {
                    ...
                    var _msg =
                        "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Student ID already exists.</div>"
                    _frm.prepend(_msg)
