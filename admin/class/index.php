...
<div class="card card-outline cardprimary w-fluid">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a class="primary-link new_class" href="javascript:void(0)"><i class="fa fa-plus"></i> Add New</a>
        </div>
    </div>
    <div class="card-body">
                    ...
                    <td class="text-center">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item action_load" href="javascript:void(0)"
                                    data-id="<?php echo $row['id'] ?>">Load Subjects</a>
