...
<div class="card card-outline cardprimary w-fluid">
    <div class="card-header">
        ...
        <!-- <div class="card-tools">
            <button class="primary-button w-110" type="button" id="my_backpack">My Backpack</button>
        </div> -->
    </div>
    <div class="card-body">
        <div class="w-100">
...
$(function() {
    ...
    _content.find("video.note-video-clip, img,iframe.pdf_viewer").each(function() {
        ...
        var backpack_btn = $(
            '<button class="primary-button w-150 px-1 py-0 mt-2 to_backpack" type="button" data-src="' +
            src + '">')
        ...
        backpack_btn.click(function() {
            uni_modal("Add to Backpack",
                "backpack/add_file.php?lesson_id=<?php echo $id ?>&file_path=" + src,
                "mid-large")
        })
    ...
    $('#my_backpack').click(function() {
        uni_modal("My Backpack Items for <?php echo $title ?> lesson",
            'backpack/per_lesson.php?lesson_id=<?php echo $id ?>', 'mid-large')
    })
})
</script>