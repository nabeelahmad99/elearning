...
<div class="card card-outline card-primary mx-5">
    <div class="card-body ">
        <div class="container-fluid ">
            ...
            <form action="" id="manage-user">
                <input style="mt-2" type="hidden" name="id" size="50" value="<?php echo $_settings->userdata('id') ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="customFile">Choose DP</label>
                    </div>
                </div>
    ...
    <div class="card-footer">
        <div class="col-md-12 text-right">
            <button class="primary-button w-80" form="manage-user">Update</button>
        </div>
    </div>
</div>
<style>
