...
<div class="card card-outline card-primary">
        ...
        <div class="container-fluid">
            <form action="" id="manage-lesson">
                ...
                <div class="form-group">
                    ...
                    <select name="subject_id" id="subject_id" class="custom-select custom-select-sm select2"
                        required="">
                        <option></option>
                        <?php
                        ...
                        <option value="<?php echo $row['id'] ?>"
                            <?php echo isset($subject_id) && $subject_id == $row['id'] ? 'selected' : '' ?>>
                            <?php echo $row['subject_code'] . ' - ' . $row['description'] ?></option>
                        <?php endwhile; ?>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select name="class_ids[]" id="class_id" class="custom-select custom-select-sm select2" required=""
                        ...
                        <option value="<?php echo $row['class_id'] ?>"
                            <?php echo isset($class_arr) && (in_array($row['class_id'], $class_arr)) ? 'selected' : '' ?>>
                ...
                <!-- <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="ppt_slide[]" multiple=""
                        accept="image/x-png,image/gif,image/jpeg" <?php // echo !isset($id) ? "required" : ""; 
                                                                    ?>>
                </div> -->
            </form>
        </div>
    ...
    <div class="card-footer">
        <div class="col-md-12 text-right">
            <button class="primary-button w-80 mr-2" form="manage-lesson">Save</button>
            <a type="cutton" class="default-link" href="./?page=lesson">Cancel</a>
        </div>
    </div>
</div>
<script>
